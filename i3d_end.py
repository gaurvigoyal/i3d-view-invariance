...
class InceptionI3d(snt.AbstractModule):
  ...
  def __init__(self, build_fn=None, num_classes=400, spatial_squeeze=True,
  ...
  def _build(self, inputs, is_training, dropout_keep_prob=1.0):
    ...
    return self._build_fn(self, net, end_points, inputs, is_training, dropout_keep_prob)

    # if self._build_fn == 'nucla4':

    #   end_point = 'Mixed_5c'
    #   with tf.variable_scope(end_point):
    #     with tf.variable_scope('Branch_0'):
    #       branch_0 = Unit3D(output_channels=384, kernel_shape=[1, 1, 1],
    #                         name='Conv3d_0a_1x1')(net, is_training=True)
